...
--  This package instantiates various CRCs that use tables stored in read-only
--  data sections.
--
--  These CRC definitions were obtained from the catalogue at:
--  https://reveng.sourceforge.io/crc-catalogue/
--  Only the "attested" and "confirmed" model classes are defined here.

package LibCRC.Predefined with
  Preelaborate,
  SPARK_Mode,
  Always_Terminates
is
   ...
   package CRC_8_AUTOSAR is new CRC_8bit.Table_Based
     (Seed                => 16#FF#,
      ...
      CRC_Table           => LibCRC.Predefined_Constant_Tables
   ...
   package CRC_64_ECMA_182 is new LibCRC.CRC_64bit.Table_Based
     (Seed                => 16#00000000_00000000#,
      ...
      CRC_Table_Reflected => False,
      CRC_Table           =>
        LibCRC.Predefined_Constant_Tables
